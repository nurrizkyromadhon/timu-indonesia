...
while ($hasil = mysql_fetch_array($query)) {
    ...
    $query_log = mysql_query("SELECT * from pf_log 
					where id_pf_log = '$id_pf_log'");
    $hasil_log = mysql_fetch_array($query_log);
    $no_jo = $hasil_log['no_jo'];
