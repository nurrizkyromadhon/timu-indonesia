...
session_start();
 ...
 <center>Untuk mengakses modul, Anda harus login <br>";
  echo "<a href=../../index.php><b>LOGIN</b></a></center>";
	...
	$aksi="modul/mod_jurnal/aksi_jurnal.php";
switch($_GET[act]){
	// Tampil User
default:
?>
					  	...
					  	<form name="submit" action="" method="post"	>	
							  <table>
								  <tr>
									  ...
									  <td><input type="date" name="tgl_aw" ></td>
									  <td><b>s/d</b></td>
							...
							<div class="box-body">						
								<table id="myTable" class="table table-bordered table-striped">
									...
									<tbody>
										<?php
											$no=1;
											$query="SELECT * FROM jurnal where tgl between '$tgl_aw_a' and '$tgl_ak' ORDER BY tgl desc";
...
?>
	...
	<section class="content">
	  ...
	  <!-- SELECT2 EXAMPLE -->
		<div class="box box-default">
			<div class="box-header with-border">
				<h3 class="box-title">Form Jurnal Khusus Pengeluaran Cek dan BG</h3>
			</div>
			<!-- /.box-header -->
			<div class="box-body">
				<div class="row">
									...
									<div class="box-body">
										<div class="form-group">
										  ...
										  <div class="col-sm-3">
										    ...
										    <?php
										    $query=mysql_query("select * from jurnal as j join perkiraan as p on j.id_perkiraan=p.id_perkiraan where j.id_perkiraan='73' order by no_jurnal ASC");
										    while($hasil=mysql_fetch_array($query)){
										       $no_jurnal=$hasil['no_jurnal']; 
										       $no_j=substr("$no_jurnal",8);
										       $no_j=$no_j+1;
										    }
										    echo "Nomor Jurnal terakhir : $no_jurnal.<br>";
										    echo "Nomor Jurnal sekarang adallah : $no_j";
										    ?>
										  </div>
										</div>
									<?php
					...
					<form class="form-horizontal" method="POST" action="<?=$aksi?>?module=jurnal&act=edit">
						...
						<div class="col-md-12">	
							...
							<div class="box-body">
								...
								<div class="form-group">
								  <label class="col-sm-2 control-label">No CEK dan BG</label>
								  <div class="col-sm-6">
									<input type="text" class="form-control" name="bgcek"  value="<?php echo $update['bgcek'];?>">
								  </div>
								</div>
								<div class="form-group">
