...
session_start();
 ...
 <center>Untuk mengakses modul, Anda harus login <br>";
  echo "<a href=../../index.php><b>LOGIN</b></a></center>";
	...
	$aksi="modul/mod_laporan/aksi_op_cash_jo.php";
	switch($_GET[act]){
		// Tampil User
		default:
				...
				<section class="content">
                  ...
                  <div class="box box-default">
						...
						<div class="box-header with-border row">
							<div class="col-md-6">
								<h3 class="box-title"><b class="text-blue">Tabel Laporan OP CASH</b> dari tgl <strong><?=$tgl_aw_str?></strong> s/d <strong><?=$tgl_ak_str?></strong> </h3>
							</div>
							<div class="col-md-6">
							...
							<div class="row">
								...
								<div class="tabel-responsive">
                                    ...
                                    <div>
                                        ...
                                        <b id='jmlOpcash'></b>
                                        <a class="btn bg-gray btn-sm" href="<?=$aksi?>?module=op_cash_jo&act=print_op_cash_jo_all&tgl_aw=<?=$tgl_aw?>&tgl_ak=<?=$tgl_ak?>" target="_blank"><span class="fa fa-print"></a>
                                        <a class="btn bg-primary btn-sm" href="<?=$aksi?>?module=op_cash_jo&act=excel_all&tgl_aw=<?=$tgl_aw?>&tgl_ak=<?=$tgl_ak?>" ><span class="fa fa-save"></a>
                                    </div>    
									<table id="myTable" class="table table-striped table-bordered">
										...
										<tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn bg-black btn-sm" href="?module=op_cash_jo&act=op_cash_jo&id_pf_log=<?=$id_pf_log?>&no_jo=<?=$no_jo?>" target="_blank"><span class="fa fa-eye"></a>	
                                                    <a class="btn bg-gray btn-sm" href="<?=$aksi?>?module=op_cash_jo&act=print_op_cash_jo&id=<?= $id_pf_log ?>&no_jo=<?=$no_jo?>" target="_blank"><span class="fa fa-print"></a>
                                                    <a class="btn bg-primary btn-sm" href="<?=$aksi?>?module=op_cash_jo&act=excel&id=<?= $id_pf_log ?>&no_jo=<?=$no_jo?>" ><span class="fa fa-save"></a>
                                                    <?php
													...
													<a class="btn bg-green btn-sm" href="<?=$aksi?>?module=op_cash_jo&act=balik_op_kas&id_pf_log=<?= $id_pf_log ?>" >OP BALIK</a>
													<?php }?>
                                                </td>
                                            </tr>
                                            <?php 
			...
			?>
				...
				<section class="content">
				  ...
				  <!-- SELECT2 EXAMPLE -->
					<div class="box box-default">
						<div class="box-header with-border">
							<h3 class="box-title">OP CASH JO <?=$no_jo?></h3>
						</div>
						<!-- /.box-header -->
						<div class="box-body">
							<div class="row">
