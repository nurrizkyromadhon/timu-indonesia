...
if (empty($_SESSION['username']) and empty($_SESSION['passuser'])) {
 ...
 <center>Untuk mengakses modul, Anda harus login <br>";
	...
	$aksi = "modul/mod_laporan/aksi_gabungan2.php";
	...
	switch ($_GET[act]) {
		...
		default:
			...
			if (empty($_POST['tgl_aw'])) {
				...
				$tgl_ak2 = date('Y-m-d', strtotime($hari_ini));
			...
			<section class="content">
				...
				<div class="box box-default">
					...
					<div class="box-header with-border row">
						<div class="col-md-6">
							<h3 class="box-title"><b class="text-blue">Tabel Laporan Gabungan II</b> dari tgl <strong><?= $tgl_aw_str ?></strong> s/d <strong><?= $tgl_ak_str ?></strong> </h3>
						</div>
						<div class="col-md-6">
							<form name="submit" action="?module=gabungan2" method="POST">
									...
									<table id="myTable" class="table table-striped table-bordered">
										...
										<tbody>
											<tr>
												...
												<td></td>
												<td>
													<a class="btn bg-black btn-sm" href="?module=revenue"><span class="fa fa-eye"></a>
												</td>
											</tr>
											<tr>
												<td>2</td>
											...
											<tr>
												...
												<td></td>
												<td>
													<a class="btn bg-black btn-sm" href="#"><span class="fa fa-eye"></a>
												</td>
											</tr>
											<tr>
												<td>4</td>
												...
												<td></td>
												<td>
													<a class="btn bg-black btn-sm" href="?module=pengeluaran_lain"><span class="fa fa-eye"></a>
												</td>
											</tr>
											<td>5</td>
											<td></td>
