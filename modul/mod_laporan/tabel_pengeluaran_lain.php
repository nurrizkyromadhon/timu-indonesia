...
session_start();
 ...
 <center>Untuk mengakses modul, Anda harus login <br>";
  echo "<a href=../../index.php><b>LOGIN</b></a></center>";
	...
	$aksi="modul/mod_laporan/aksi_pengeluaran_lain.php";
	switch($_GET[act]){
		// Tampil User
		default:
				...
				<section class="content">
                  ...
                  <div class="box box-default">
						...
						<div class="box-header with-border row">
							<div class="col-md-6">
								<h3 class="box-title"><b class="text-blue">Tabel Laporan Pengeluaran Non JO </b> dari tgl <strong><?=$tgl_aw_str?></strong> s/d <strong><?=$tgl_ak_str?></strong> </h3>
							</div>
							<div class="col-md-6">
								<form name="submit" action="?module=pengeluaran_lain" method="POST">
						...
						<div class="box-body">
							<div class="row">
								...
								<div class="tabel-responsive">
									<div class="col-md-12">
                                    <div>
                                        <b class="text-danger">TABEL PENGELUARAN NON JO SALDO TERAKHIR : Rp. </b>
                                        <b id='jmlOpcash'></b>
                                        <a class="btn bg-gray btn-sm" href="<?=$aksi?>?module=overhead&act=print_overhead_all&tgl_aw=<?=$tgl_aw?>&tgl_ak=<?=$tgl_ak?>" target="_blank"><span class="fa fa-print"></a>
                                        <a class="btn bg-primary btn-sm" href="<?=$aksi?>?module=overhead&act=excel_all&tgl_aw=<?=$tgl_aw?>&tgl_ak=<?=$tgl_ak?>" ><span class="fa fa-save"></a>
                                    </div>    
									<table id="myTable" class="table table-striped table-bordered">
										...
										<tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn bg-black btn-sm" href="?module=pengeluaran_lain&act=overhead_kat&kategori=<?=$kategori?>&tgl_aw=<?=$tgl_aw?>&tgl_ak=<?=$tgl_ak?>" target="_blank"><span class="fa fa-eye"></a>	
													<a class="btn bg-gray btn-sm" href="<?=$aksi?>?module=overhead&act=print_overhead_tgl&kategori=<?=$kategori?>&tgl_aw=<?=$tgl_aw?>&tgl_ak=<?=$tgl_ak?>" target="_blank"><span class="fa fa-print"></a>
													<a class="btn bg-primary btn-sm" href="<?=$aksi?>?module=overhead&act=excel&kategori=<?=$kategori?>&tgl_aw=<?=$tgl_aw?>&tgl_ak=<?=$tgl_ak?>" ><span class="fa fa-save"></a>                                                    
                                                </td>
                                            </tr>
                                            <?php 
                                                $no++; } 
			...
			?>
				...
				<section class="content-header">
					...
					<ol class="breadcrumb">
						...
						<li class="active">Pengeluaran Lain</li>
					</ol>
				</section>
