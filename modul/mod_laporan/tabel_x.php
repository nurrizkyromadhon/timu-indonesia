...
if (empty($_SESSION['username']) and empty($_SESSION['passuser'])) {
 ...
 <center>Untuk mengakses modul, Anda harus login <br>";
	...
	$aksi = "modul/mod_laporan/aksi_x.php";
	switch ($_GET[act]) {
			// Tampil User
		default:
			...
			<section class="content">
				...
				<div class="box box-default">
					...
					<div class="box-header with-border row">
						<div class="col-md-6">
							<h3 class="box-title"><b class="text-blue">Tabel Laporan X</b> dari tgl <strong><?= $tgl_aw_str ?></strong> s/d <strong><?= $tgl_ak_str ?></strong> </h3>
						</div>
						<div class="col-md-6">
							...
							<div class="tabel-responsive">
								<div class="col-md-12">
									<div>
										...
										<b id='jmlOpcash'></b>
										<a class="btn bg-gray btn-sm" href="<?= $aksi ?>?module=x&act=print_x_all&tgl_aw=<?= $tgl_aw ?>&tgl_ak=<?= $tgl_ak ?>" target="_blank"><span class="fa fa-print"></a>
										<a class="btn bg-primary btn-sm" href="<?= $aksi ?>?module=x&act=excel_all&tgl_aw=<?= $tgl_aw ?>&tgl_ak=<?= $tgl_ak ?>"><span class="fa fa-save"></a>
									</div>
									<table id="myTable" class="table table-striped table-bordered">
										...
										<tbody>
											...
											$qry_oc = mysql_query("select * from pf_real_cost                                              
                                                where tgl_pf_real_cost between '$tgl_aw' and '$tgl_ak' and category2 IN('BBK','BKK','BBM','BKM') and category1 = 'X' group by category2 order by category2 desc");
											...
											?>
												<tr>
													...
													<td>
														<a class="btn bg-black btn-sm" href="?module=x&act=kategori&kategori=<?= $kategori ?>&tgl_aw=<?= $tgl_aw ?>&tgl_ak=<?= $tgl_ak ?>" target="_blank"><span class="fa fa-eye"></a>
														<a class="btn bg-gray btn-sm" href="<?= $aksi ?>?module=x&act=print_x&kategori=<?= $kategori ?>&tgl_aw=<?= $tgl_aw ?>&tgl_ak=<?= $tgl_ak ?>" target="_blank"><span class="fa fa-print"></a>
														<a class="btn bg-primary btn-sm" href="<?= $aksi ?>?module=x&act=excel&kategori=<?= $kategori ?>&tgl_aw=<?= $tgl_aw ?>&tgl_ak=<?= $tgl_ak ?>"><span class="fa fa-save"></a>
													</td>
												</tr>
											<?php
												$no++;
