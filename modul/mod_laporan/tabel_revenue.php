...
session_start();
 ...
 <center>Untuk mengakses modul, Anda harus login <br>";
  echo "<a href=../../index.php><b>LOGIN</b></a></center>";
	...
	$aksi="modul/mod_laporan/aksi_revenue.php";
	switch($_GET[act]){
		// Tampil User
		default:
				...
				<section class="content">
                  ...
                  <div class="box box-default">
						...
						<div class="box-header with-border row">
							<div class="col-md-6">
								<h3 class="box-title"><b class="text-blue">Tabel Laporan Revenue</b> dari tgl <strong><?=$tgl_aw_str?></strong> s/d <strong><?=$tgl_ak_str?></strong> </h3>
							</div>
							<div class="col-md-6">
								<form name="submit" action="?module=revenue" method="POST">
							...
							<div class="row">
								...
								<div class="tabel-responsive">
                                    ...
                                    <div>
                                        ...
                                        <b id='jmlOpcash2'></b>
                                        <a class="btn bg-gray btn-sm" href="<?=$aksi?>?module=revenue&act=print_revenue_all&tgl_aw=<?=$tgl_aw?>&tgl_ak=<?=$tgl_ak?>" target="_blank"><span class="fa fa-print"></a>
                                        <a class="btn bg-primary btn-sm" href="<?=$aksi?>?module=revenue&act=excel_all&tgl_aw=<?=$tgl_aw?>&tgl_ak=<?=$tgl_ak?>" ><span class="fa fa-save"></a>
                                    </div>    
									<table id="myTable" class="table table-striped table-bordered">
										...
										<tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn bg-black btn-sm" href="?module=revenue&act=revenue_jo&id_pf_log=<?=$id_pf_log?>&no_jo=<?=$hasil['no_jo']?>" target="_blank"><span class="fa fa-eye"></a>	
                                                    <a class="btn bg-gray btn-sm" href="<?=$aksi?>?module=revenue&act=print_revenue_jo&id=<?= $id_pf_log ?>" target="_blank"><span class="fa fa-print"></a>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?=$no?></td>
														...
														<td>
															<?php
																$saldo_cost=$saldo_cost+$hsl['real_cost'];
																echo number_format($saldo_cost);
															?>
														</td>
                                                </tr>
                                                <?php $no++; } ?>
