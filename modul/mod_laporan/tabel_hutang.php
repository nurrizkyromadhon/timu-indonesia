			...
			<script type="text/javascript">					
				...
				<section class="content-header">
					...
					<ol class="breadcrumb">
						...
						<li class="active">Tabel Hutang</li>
					</ol>
				</section>
				...
				<section class="content">
                  ...
                  <div class="box box-default">
						...
						<div class="box-header with-border row">
							...
							<div class="col-md-6">
								<form name="submit" action="?module=hutang" method="POST">
							...
							<div class="row">
								<div class="tabel-responsive">
									...
									<table id="myTable" class="table table-striped table-bordered">
										...
										<tbody>
                                        <?php
                                            $qryrc=die("select * from pf_real_cost 
                                            where no_reff_keu like 'HUT%' or id_hut ='0' and tgl_pf_real_cost < $tgl_aw ");                                                   
										?>
                                        <tr>
											...
											$no_real_cost=1;
												...
												no_reff_keu like 'HUT%' or id_hut != '0'
												order by id_pf_real_cost");
