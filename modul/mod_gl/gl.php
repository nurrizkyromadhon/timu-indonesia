							...
							<div class="box-body">						
								<table id="myTable" class="table table-bordered table-striped">
									...
									<tbody>
										<?php
											$no=1;
											$query="SELECT * FROM jurnal where tgl between '$tgl_aw_a' and '$tgl_ak' and id_perkiraan !='73' ORDER BY tgl desc";
											$qry=mysql_query($query);
											while ($hasil=mysql_fetch_array($qry)){
												$query2="SELECT * FROM perkiraan WHERE id_perkiraan='$hasil[id_perkiraan]' and id_perkiraan !='73'";
												...
												?>
													<tr>
														...
														while ($hasil3=mysql_fetch_array($query3)){
															if($hasil3['dk']=='D'){
																$jmlD=$jmlD+$hasil3['nominal'];
															}else{
																$jmlK=$jmlK+$hasil3['nominal'];
															}	
														}
														$jml=$jmlD-$jmlK;
														?>
