										...
										<div class="row with-border">
											<div class="col-md-6">
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														<div class="row mb-2">
															<div class="col-sm-3 nopadding-right"><input onkeyup="this.value = this.value.toUpperCase()" oninput="changeQtyValue(0, this.value)" type="text" class="form-control pf_qty pf_qty_0" name="party_pf0[]" placeholder="quantity" required></div>
														...
														<div class="row mb-2">
															...
															<div class="col-sm-7"><input onkeyup="this.value = this.value.toUpperCase()" oninput="changeQtyDesc1Value(0, this.value)" type="text" class="form-control pf_qty_desc1_0" name="party_pf1_desc[]" placeholder="isi jika opsi ... dipilih" autofocus></div>
														</div>
														<div class="row mb-2">
															<div class="col-sm-5 nopadding-right">
															...
															<div class="col-sm-7"><input onkeyup="this.value = this.value.toUpperCase()" oninput="changeQtyDesc2Value(0, this.value)" type="text" class="form-control pf_qty_desc2_0" name="party_pf2_desc[]" placeholder="isi jika opsi ... dipilih" autofocus></div>
														</div>
												...
												<script type="text/javascript">
													...
													function addMoreParty() {
														...
														<div class="form-group qty-item-${qtyRow}">
															...
															<div class="col-sm-6">
																<div class="row mb-2">
																	<div class="col-sm-3 nopadding-right"><input onkeyup="this.value = this.value.toUpperCase()" oninput="changeQtyValue(${qtyRow}, this.value)" type="text" class="form-control pf_qty pf_qty_${qtyRow}" name="party_pf0[]" placeholder="quantity" autofocus required></div>
																	<div class="col-sm-1"><label class="control-label">X</label></div>
																</div>
																<div class="row mb-2">
																	<div class="col-sm-5 nopadding-right">
																	...
																	<div class="col-sm-7"><input onkeyup="this.value = this.value.toUpperCase()" oninput="changeQtyDesc1Value(${qtyRow}, this.value)" type="text" class="form-control pf_qty_desc1_${qtyRow}" name="party_pf1_desc[]" placeholder="isi jika opsi ... dipilih" autofocus></div>
																</div>
																<div class="row mb-2">
																	<div class="col-sm-5 nopadding-right">
																	...
																	<div class="col-sm-7"><input onkeyup="this.value = this.value.toUpperCase()" oninput="changeQtyDesc2Value(${qtyRow}, this.value)" type="text" class="form-control pf_qty_desc2_${qtyRow}" name="party_pf2_desc[]" placeholder="isi jika opsi ... dipilih" autofocus></div>
																</div>
																<div class="border-w"></div>
															</div>
														</div>
												...
												<div class="form-group">
													...
													<div class="col-sm-6">
														...
														<div class="row mb-2">
															<div class="col-sm-3 nopadding-right"><input onkeyup="this.value = this.value.toUpperCase()" oninput="changeQtyPudel(0, this.value)" type="text" id="pudel-qty-0" class="form-control" name="pudel_party_qty[]" placeholder="quantity" autofocus required></div>
															<div class="col-sm-1"><label class="control-label">X</label></div>
														</div>
														<div class="row mb-2">
															<div class="col-sm-5 nopadding-right">
															...
															<div class="col-sm-7"><input onkeyup="this.value = this.value.toUpperCase()" oninput="changeDesc1Pudel(0, this.value)" type="text" id="pudel-qty-desc1-0" class="form-control" name="pudel_party_pf1_desc[]" placeholder="isi jika opsi ... dipilih" autofocus></div>
														</div>
														<div class="row mb-2">
															<div class="col-sm-5 nopadding-right">
															...
															<div class="col-sm-7"><input onkeyup="this.value = this.value.toUpperCase()" oninput="changeDesc2Pudel(0, this.value)" type="text" id="pudel-qty-desc2-0" class="form-control" name="pudel_party_pf2_desc[]" placeholder="isi jika opsi ... dipilih" autofocus></div>
														</div>
														<div class="row">
													...
													function addMorePudel() {
														...
														<div class="form-group pudel-item-${pudelRow}">
															...
															<div class="col-sm-6">
																...
																<label class="control-label sub-label-margin">QTY</label>
																<div class="row mb-2">
																	<div class="col-sm-3 nopadding-right"><input onkeyup="this.value = this.value.toUpperCase()" oninput="changeQtyPudel(${pudelRow}, this.value)" type="text" id="pudel-qty-${pudelRow}" class="form-control" name="pudel_party_qty[]" placeholder="quantity" autofocus required></div>
																	<div class="col-sm-1"><label class="control-label">X</label></div>
																</div>
																<div class="row mb-2">
																	<div class="col-sm-5 nopadding-right">
																	...
																	<div class="col-sm-7"><input onkeyup="this.value = this.value.toUpperCase()" oninput="changeDesc1Pudel(${pudelRow}, this.value)" type="text" id="pudel-qty-desc1-${pudelRow}" class="form-control" name="pudel_party_pf1_desc[]" placeholder="isi jika opsi ... dipilih" autofocus></div>
																</div>
																<div class="row mb-2">
																	<div class="col-sm-5 nopadding-right">
																	...
																	<div class="col-sm-7"><input onkeyup="this.value = this.value.toUpperCase()" oninput="changeDesc2Pudel(${pudelRow}, this.value)"  type="text" id="pudel-qty-desc2-${pudelRow}" class="form-control" name="pudel_party_pf2_desc[]" placeholder="isi jika opsi ... dipilih" autofocus></div>
																</div>
																<div class="row">
																	<div class="col-sm-6"><label class="control-label sub-label-margin">FROM</label></div>
																	<div class="col-sm-6"><label class="control-label sub-label-margin">TO</label></div>
									...
									<div class="box-body">
										...
										<div class="product-item-rev-0 mb-4">
											...
											<div id="rev-qty-product-0" class="form-group revenue-index-0">
												<div class="col-sm-4 product-item-rev-qty0-0 mb-3">
										...
										<script type="text/javascript">
											...
											function addMoreRevQty(index) {
												...
												<div class="col-sm-4 mb-3 product-item-rev-qty${index}-${qtyRevRow[index]}">
													...
													<div class="row mb-2">
														<div class="col-sm-6">
															<label>QTY</label>
															<input onkeyup="this.value = this.value.toUpperCase()" value="${pf_qty_data !== undefined ? pf_qty_data : ''}" type="text" class="form-control rev-qty-${qtyRevRow[index]}" name="qty_rev${index}[]" placeholder="quantity" autofocus required>
														</div>
														<div class="col-sm-6 w-content mt-2">
															<label class="control-label">X</label>
														</div>
													...
													<div class="row mb-2">
														...
														<div class="col-sm-6"><input onkeyup="this.value = this.value.toUpperCase()" value="${pf_desc1_data !== undefined ? pf_desc1_data : ''}" type="text" class="form-control rev-qty-desc1-${qtyRevRow[index]}" name="qty_desc1_rev${index}[]" placeholder="isi jika opsi ... dipilih" autofocus></div>
													</div>
													<div class="row mb-2">
														<div class="col-sm-6">
														...
														<div class="col-sm-6"><input onkeyup="this.value = this.value.toUpperCase()" value="${pf_desc2_data !== undefined ? pf_desc2_data : ''}" type="text" class="form-control rev-qty-desc2-${qtyRevRow[index]}" name="qty_desc2_rev${index}[]" placeholder="isi jika opsi ... dipilih" autofocus></div>
													</div>
													<div class="row mb-2">
														<div class="col-sm-12">
															<label>RATE</label>
													...
													<div class="row mb-2">
														<div class="col-sm-6">
															...
															<select class="form-control rev-ppn-${index} rev-ppn-${index}-${qtyRevRow[index]}" name="ppn_rev${index}[]">
																<option value="${ppn_data !== undefined ? ppn_data : "0"}">${ppn_text !== undefined && ppn_text !== "0" ? ppn_text : "- PILIH JIKA DIKENAKAN -"}</option>
																<option value="1.1" >1.1%</option>
																<option value="11" >11%</option>
															</select>
														</div>
														<div class="col-sm-6">
															...
															<select class="form-control rev-pph-${index} rev-pph-${index}-${qtyRevRow[index]}" name="pph_rev${index}[]">
																<option value="${pph_data !== undefined ? pph_data : "0"}">${pph_text !== undefined && pph_text !== "0" ? pph_text : "- PILIH JIKA DIKENAKAN -"}</option>
																<option value="2" >2%</option>
															</select>
														</div>
													</div>
									...
									<div class="box-body">	
										...
										<div class="product-item mb-4">
											...
											<div id="cost-qty-product-0" class="form-group cost-index-0">
												<div class="col-sm-4 mb-3 product-item-cost-qty0-0">
													<div hidden class="from-to row mb-2">
														<div class="col-sm-6">
															<label>FROM</label>
										...
										<script type="text/javascript">
											...
											function addMoreCostQty(index) {
												...
												<div class="col-sm-4 mb-3 product-item-cost-qty${index}-${qtyCostRow[index]}">
													...
													<div class="row mb-2">
														<div class="col-sm-6">
															<label>QTY</label>
															<input onkeyup="this.value = this.value.toUpperCase()" value="${pf_qty_data !== undefined ? pf_qty_data : ''}" type="text" class="form-control cost-qty-${qtyCostRow[index]}" name="qty_cost${index}[]" placeholder="quantity" autofocus required>
														</div>
														<div class="col-sm-6 w-content mt-2">
															<label class="control-label">X</label>
														</div>
													...
													<div class="row mb-2">
														...
														<div class="col-sm-6"><input onkeyup="this.value = this.value.toUpperCase()" value="${pf_desc1_data !== undefined ? pf_desc1_data : ''}" type="text" class="form-control cost-qty-desc1-${qtyCostRow[index]}" name="qty_desc1_cost${index}[]" placeholder="isi jika opsi ... dipilih" autofocus></div>
													</div>
													<div class="row mb-2">
														<div class="col-sm-6">
														...
														<div class="col-sm-6"><input onkeyup="this.value = this.value.toUpperCase()" value="${pf_desc2_data !== undefined ? pf_desc2_data : ''}" type="text" class="form-control cost-qty-desc2-${qtyCostRow[index]}" name="qty_desc2_cost${index}[]" placeholder="isi jika opsi ... dipilih" autofocus></div>
													</div>
													<div class="row mb-2">
														<div class="col-sm-12">
															<label>RATE</label>
						...
						<div class="box-body">
							<div class="col-md-5">
								<table style="width:100%">
									...
									<tr>
										<td class="align-start">PICK UP DELIVERY</td>
										<td class="align-start">:</td>
										<td>
											<div class="row">
												<div class="col-sm-3"><p class="nopadding">DATE</p></div>
												<div class="col-sm-4"><p class="nopadding">QTY</p></div>
												<div class="col-sm-4"><p class="nopadding">FROM / TO</p></div>
											</div>
											<?php
												$query3 = mysql_query("SELECT * from pf_pudel where id_pf=$id_pf");
												while ($hasilPudel = mysql_fetch_array($query3)) { ?>
											<div class="row">
												<div class="col-sm-3"><p class="nopadding"><?=$hasilPudel['pudel_date']?></p></div>
												<div class="col-sm-4"><p class="nopadding"><?=$hasilPudel['qty']?> X <?=$hasilPudel['type1']?> <?=$hasilPudel['type2']?></p></div>
												<div class="col-sm-4"><p class="nopadding"><?=$hasilPudel['pudel_from']?> / <?=$hasilPudel['pudel_to']?></p></div>
											</div>
												<?php
												}
											?>
					...
					<div class="bg-default">
						<div class="box-body">
							<div class="row">
								<div class="col-md-6">
									<h4>
										<a><bold>TABLE EST REVENUE</bold></a>
										<?php
											if(empty($hasil['aprove'])) {
										?>
										<!-- Modal -->
