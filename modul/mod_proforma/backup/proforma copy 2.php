								...
								<div class="row">
									<div class="table-responsive">
										<div class="box-body">
											<div class="col-sm-12">
												<div class="row">
													<div class="col-md-4"><input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control pf_qty pf_qty_0" name="party_pf0[]" placeholder="quantity" required></div>
													<div class="col-md-4">
														...
														<div hidden class="col-md-7"><input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control pf_qty_desc1_0" name="party_pf1_desc[]" placeholder="isi jika opsi ... dipilih" autofocus></div>
													</div>
													<div class="col-md-4">
														...
														<div hidden class="col-md-7"><input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control pf_qty_desc2_0" name="party_pf2_desc[]" placeholder="isi jika opsi ... dipilih" autofocus></div>
													</div>
												</div>
											</div>
										</div>
										...
										<script type="text/javascript">
											...
											function addMoreParty() {
												$("#party").append(`
												<div class="box-body qty-item-${qtyRow}">
													<div class="col-sm-12">
														<div class="row">
															<div class="col-md-4"><input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control pf_qty pf_qty_${qtyRow}" name="party_pf0[]" placeholder="quantity" autofocus required></div>
															<div class="col-md-4">
																...
																<div hidden class="col-md-7"><input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control pf_qty_desc1_${qtyRow}" name="party_pf1_desc[]" placeholder="isi jika opsi ... dipilih" autofocus></div>
															</div>
															<div class="col-md-4">
																...
																<div hidden class="col-md-7"><input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control pf_qty_desc2_${qtyRow}" name="party_pf2_desc[]" placeholder="isi jika opsi ... dipilih" autofocus></div>
															</div>
														</div>
													</div>
												</div>
										...
										<div class="col-md-12">	
											<div class="box-body">
												...
												<script type="text/javascript">
													...
													function addMore0() {
														idrow++;
														$("#product0").append("<div class='product-item form-group'><div class='col-md-10'><input type='text' class='form-control' name='desc_sor[]' placeholder='Description'></div><div class='col-sm-2'><input type='checkbox' class='pull-left' name='item_index[]'></div></div>");
													}
													function deleteRow0() {
					...
					<div class="col-md-8">
						<div class="box box-default">
							...
							<div class="box-body">
								<div class="row">
									<div class="table-responsive">
										<div class="box-body pudel-item-0">
											<div class="col-sm-12">
												<label class="sub-label-margin">DATE</label>
												<input onkeyup="this.value = this.value.toUpperCase()" type="datetime-local" class="form-control" name="pudel_date0[]" autofocus>
												<label class="control-label sub-label-margin">QTY</label>
												<div class="row">
													<div class="col-md-4"><input onkeyup="this.value = this.value.toUpperCase()" type="text" id="pudel-qty-0" class="form-control" name="pudel_party_qty[]" placeholder="quantity" autofocus></div>
													<div class="col-md-4">
														<select onchange="changeType1Pudel(0, this.value)" class="form-control" id="pudel-qty-type1-0" name="pudel_party_pf1[]" autofocus>
															<option value="">- PILIH -</option>
															<option value="20FT" >20FT</option>
															<option value="40FT">40FT</option>
															<option value="45FT">45FT</option>
														...
														<div hidden class="col-md-7"><input onkeyup="this.value = this.value.toUpperCase()" type="text" id="pudel-qty-desc1-0" class="form-control" name="pudel_party_pf1_desc[]" placeholder="isi jika opsi ... dipilih" autofocus></div>
													</div>
													<div class="col-md-4">
														<select onchange="changeType2Pudel(0, this.value)" class="form-control" id="pudel-qty-type2-0" name="pudel_party_pf2[]" autofocus>
															<option value="">- PILIH -</option>
															<option value="STD" >STD</option>
															<option value="HC">HC</option>
															<option value="RF">RF</option>
														...
														<div hidden class="col-md-7"><input onkeyup="this.value = this.value.toUpperCase()" type="text" id="pudel-qty-desc2-0" class="form-control" name="pudel_party_pf2_desc[]" placeholder="isi jika opsi ... dipilih" autofocus></div>
													</div>
												</div>
												<div class="row">
												...
												<div class="row">
													<div class="col-sm-6"><input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control pf_pudel_from_0" name="pudel_route_from_pf[]" autofocus></div>
													<div class="col-sm-6"><input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control pf_pudel_to_0" name="pudel_route_to_pf[]" autofocus></div>
												</div>
										...
										<div class="box-body">
											<div class="col-sm-12 btn-action">
										...
										<script type="text/javascript">
											...
											function addMorePudel() {
												$("#pudel").append(`
												<div class="box-body pudel-item-${pudelRow}">
													<div class="col-sm-12">
														<label>DATE</label>
														<input onkeyup="this.value = this.value.toUpperCase()" type="datetime-local" class="form-control" name="pudel_date0[]" autofocus>
														<label class="control-label sub-label-margin">QTY</label>
														<div class="row">
															<div class="col-md-4"><input onkeyup="this.value = this.value.toUpperCase()" type="text" id="pudel-qty-${pudelRow}" class="form-control" name="pudel_party_qty[]" placeholder="quantity" autofocus></div>
															<div class="col-md-4">
																<select onchange="changeType1Pudel(${pudelRow}, this.value)" class="form-control" id="pudel-qty-type1-${pudelRow}" name="pudel_party_pf1[]" autofocus>
																	<option value="">- PILIH -</option>
																	<option value="20FT" >20FT</option>
																	<option value="40FT">40FT</option>
																	<option value="45FT">45FT</option>
																...
																<div hidden class="col-sm-7"><input onkeyup="this.value = this.value.toUpperCase()" type="text" id="pudel-qty-desc1-${pudelRow}" class="form-control" name="pudel_party_pf1_desc[]" placeholder="isi jika opsi ... dipilih" autofocus></div>
															</div>
															<div class="col-md-4">
																<select onchange="changeType2Pudel(${pudelRow}, this.value)" class="form-control" id="pudel-qty-type2-${pudelRow}" name="pudel_party_pf2[]" autofocus>
																	<option value="">- PILIH -</option>
																	<option value="STD" >STD</option>
																	<option value="HC">HC</option>
																	<option value="RF">RF</option>
																...
																<div hidden class="col-sm-7"><input onkeyup="this.value = this.value.toUpperCase()"  type="text" id="pudel-qty-desc2-${pudelRow}" class="form-control" name="pudel_party_pf2_desc[]" placeholder="isi jika opsi ... dipilih" autofocus></div>
															</div>
														</div>
														<div class="row">
															<div class="col-sm-6"><label class="control-label sub-label-margin">FROM</label></div>
														...
														<div class="row">
															<div class="col-sm-6"><input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control pf_pudel_from_${pudelRow}" name="pudel_route_from_pf[]" autofocus></div>
															<div class="col-sm-6"><input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control pf_pudel_to_${pudelRow}" name="pudel_route_to_pf[]" autofocus></div>
														</div>
														<div class="border-w"></div>
													</div>
												</div>
					...
					<div class="box-body">
						<div class="row">
							<div class="table-responsive">
								<div class="col-md-12">	
									<div class="box-body">
										<div class="ru-item product-item form-group row">
											<div class="col-md-2">
												<label>CUSTOMER NAME</label>
												<select class="form-control" id="nm_cust" name="ru_name[]" onchange="ruChangeValue(0, this.value)">
													<option value="">- SELECT -</option>
													<?php
											...
											<div class="col-md-2">
												<label>ADDRESS</label>
												<textarea onkeyup="this.value = this.value.toUpperCase()"  class="form-control" name="ru_address[]" id="ru_alamat_cust_0" autofocus></textarea>									
											</div>
											<div class="col-md-2">
												<label>CUSTOMER REF</label>
												<input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control" name="ru_ref[]" id="ru_reff_0" autofocus>
											</div>
											<div class="col-md-1">
												<label>CUSTOMER CODE</label>
												<input onkeyup="this.value = this.value.toUpperCase()"  type="text" name="ru_code[]" id="ru_code_0" class="form-control">
											</div>
											<div class="col-md-2">
												<label>PIC</label>
												<input onkeyup="this.value = this.value.toUpperCase()"  type="text" name="ru_pic[]" id="ru_pic_0" class="form-control">
											</div>
											<div class="col-md-2">
												<label>PHONE</label>
												<input onkeyup="this.value = this.value.toUpperCase()"  type="text" name="ru_phone[]" id="ru_phone_0" class="form-control">
											</div>
										...
										<script type="text/javascript">
											...
											function addReal() {
												ruRow++;
												$("#real-user").append(`
												<div class="ru-item form-group row">
													<div class="col-sm-2">
													...
													<div class="col-sm-2">
														<textarea onkeyup="this.value = this.value.toUpperCase()"  class="form-control" name="ru_address[]" id="ru_alamat_cust_${ruRow}" autofocus></textarea>									
													</div>
													<div class="col-sm-2">
														<input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control" name="ru_ref[]" id="ru_reff_${ruRow}" autofocus required>
													</div>
													<div class="col-md-1">
														<input onkeyup="this.value = this.value.toUpperCase()"  type="text" name="ru_code[]" id="ru_code_${ruRow}" class="form-control">
													</div>
													<div class="col-sm-2">
														<input onkeyup="this.value = this.value.toUpperCase()"  type="text" name="ru_pic[]" id="ru_pic_${ruRow}" class="form-control">
													</div>
													<div class="col-sm-2">
														<input onkeyup="this.value = this.value.toUpperCase()"  type="text" name="ru_phone[]" id="ru_phone_${ruRow}" class="form-control">
													</div>
													<div class="col-sm-1 mt-2">
														<input type="checkbox" class="pull-left" name="item_index[]">
													</div>
											...
											function deleteReal() {
												$('DIV.ru-item').each(function(index, item){
													jQuery(':checkbox', this).each(function () {
														if ($(this).is(':checked')) {
															$(item).remove();
														}
												...
												<div class="product-item-rev-0 mb-2">
													<div class="form-group">
														...
														<div class="col-sm-4 mt-1">
															<label>RATE</label>
															<input onkeyup="this.value = this.value.toUpperCase()"  type="text" class="form-control rev-rate-0" name="rate_rev[]" placeholder="(IDR) tanpa titik, koma" autofocus required>
														</div>
														<div class="col-sm-4 mt-1">
															<label>PPN</label>
															<select class="form-control rev-ppn-0" name="ppn_rev[]">
														...
														<div class="col-sm-4 mt-1">
															<label>PPH</label>
															<select class="form-control rev-pph-0" name="pph_rev[]">
																<option value="0">0%</option>
													...
													function addMore1() {
														...
														<div class="product-item-rev-${revRow} mb-2">
															<div class="form-group">
																...
																<div class="col-sm-4 mt-1">
																	<label>PPN</label>
																	<select class="form-control rev-ppn-${revRow}" name="ppn_rev[]">
																		<option value="0">0%</option>
																		<option value="1.1" >1.1%</option>
																		<option value="11" >11%</option>
																	</select>
																...
																<div class="col-sm-4 mt-1">
																	<label>PPH</label>
																	<select class="form-control rev-pph-${revRow}" name="pph_rev[]">
																		<option value="0">0%</option>
																		<option value="2" >2%</option>
																	</select>
																</div>
									...
									<div class="table-responsive">
										<div class="col-md-12">	
											<div class="box-body">	
												...
												<div class="product-item mb-2 product-item-cost-0">
													<div class="form-group">
														<div class="col-sm-4">
															<label>TYPE</label>
														...
														<div class="col-sm-4 mt-1">
															<label>PPN</label>
															<select class="form-control cost-ppn-0" name="ppn_cost[]">
																<option value="0">0%</option>
																<option value="1.1" >1.1%</option>
																<option value="11">11%</option>
															</select>
														...
														<div class="col-sm-4 mt-1">
															<label>PPH</label>
															<select class="form-control cost-pph-0" name="pph_cost[]">
																<option value="0">0%</option>
																<option value="2" >2%</option>
															</select>
														</div>
													...
													function addMore2() {
														...
														<div class="product-item-cost-${costRow} mb-2">
															<div class="form-group">
																...
																<div class="col-sm-4 mt-1">
																	<label>PPN</label>
																	<select class="form-control cost-ppn-${costRow}" name="ppn_cost[]">
																		<option value="0">0%</option>
																		<option value="1.1" >1.1%</option>
																		<option value="11">11%</option>
																	</select>
																...
																<div class="col-sm-4 mt-1">
																	<label>PPH</label>
																	<select class="form-control cost-pph-${costRow}" name="pph_cost[]">
																		<option value="0">0%</option>
																		<option value="2" >2%</option>
																	</select>
																</div>
							...
							<div class="table-responsive">
								<div class="col-md-12">	
									<div class="box-footer">
										<!-- Modal -->
										<div class="modal fade" id="modal-rate" role="dialog">
											<div class="modal-dialog">
												<div class="modal-content" style="color: black;">
													<div class="modal-header">
														<button type="button" class="close" data-dismiss="modal"></button>
														<h5>Save Proforma with Customer Rate</h5>
													</div>
													<div class="modal-body">
														<label>Please Enter Valid Date</label>
														<input type="date" class="form-control" name="valid_date" autofocus>
													</div>
													<div class="modal-footer">
														<button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
														<a onClick="submitFormSave(false);" class="btn btn-success">No</a>
														<a onClick="submitFormSave(true);" class="btn btn-success">Save</a>
													</div>
												</div>
											</div>
										</div>
										...
										<button hidden type="submit" id="submit-btn" name="submit" class="hidden"></button>
										<a class="btn btn-primary pull-right" onClick="submitFormData();">Submit</a>	

										<script type="text/javascript">
											function submitFormData() {
												let revLength = $('[name="type_revenue[]"]').length;
												let revData = [];
												for (let i = 0; i < revLength; i++) {
													revData.push({
														"cust_name": $('#nm_cust').val(),
														"shipment": $('#shipment').val(),
														"type_rev": $(`.rev-type-${i}`).val(),
														"desc_rev": $(`.rev-desc-${i}`).val()
													});
												}
												$.ajax({
													type: "GET",
													url: 'modul/mod_proforma/getData.php?act=submit',
													data: {data: revData},
													dataType: 'json',
													success:function(result){
														if (result.exist === 'n') $('#modal-rate').modal('toggle');
														else document.getElementById('submit-btn').click();
													}
												});
											}

											function submitFormSave(isValid) {
												if (isValid) { 
													$('#save-rate').val('y');
												}
													else { 
							...
							<div class="row mb-3">
								<div class="col-sm-6">
												...
												<tr>
													...
													<?php
														if(empty($hasil['aprove'])){ ?>
															...
															<a class="btn btn-danger btn-sm" href="<?= $aksi ?>?module=proforma&act=delete_ru&id=<?= $id_real_user ?>&id_pf=<?= $id_pf ?>"><span class="fa fa-close"></a>
													<?php } ?>
													</td>
												</tr>
											<?php
									...
									<?php
										...
										<a class="btn btn-info text-white btn-sm" data-toggle="modal" href="#qty_plus<?=$id_pf?>">TAMBAH QTY</a>
										<?php } ?>
								</div>
								<div class="col-sm-6">
									...
									<?php
										...
										<a class="btn btn-info text-white btn-sm" data-toggle="modal" href="#pudel_plus<?=$id_pf?>">TAMBAH PUDEL</a>
										<?php } ?>
								</div>
							</div>
							<div class="row">
								<div class="col-sm-6">
												...
												<tr>
													...
													<?php
														if(empty($hasil['aprove'])){ ?>
															...
															<a class="btn btn-danger btn-sm" href="<?= $aksi ?>?module=proforma&act=delete_sor&id=<?= $id_pf_sor ?>&id_pf=<?= $id_pf ?>"><span class="fa fa-close"></a>
									...
									<?php
										...
										<a class="btn btn-info text-white btn-sm" data-toggle="modal" href="#sor_plus<?=$id_pf?>">TAMBAH ORDER</a>
									<?php } ?>
								</div>
								<div class="col-sm-6">
									...
									<?php
										...
										?>
											...
											<a class="btn btn-info text-white btn-sm" data-toggle="modal" href="#ru_plus<?=$id_pf?>">TAMBAH USER</a>
										<?php } ?>
								</div>
							</div>
						</div>
