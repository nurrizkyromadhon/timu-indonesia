												...
												<script type="text/javascript">
													...
													function addMoreParty() {
														...
														<div class="form-group qty-item-${qtyRow}">
															<div class="col-sm-4"><input onkeyup="this.value = this.value.toUpperCase()" oninput="changeQtyValue(this.value)" type="text" placeholder="Isi Hanya Angka" class="form-control pf_qty pf_qty_${qtyRow}" name="party_pf0[]" autofocus required></div>
															<div class="col-sm-4">
													...
													function addMore1() {
														...
														<div class="product-item-rev-${revRow} mb-2">
															<div class="form-group">
																...
																<div class="col-sm-4 nopadding-left">
																	<label>DESCRIPTION</label>
																	<input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control rev-qty-${revRow}" name="desc_rev[]" required>
																</div>
																<div class="col-sm-2 nopadding-left">
																	<label>QTY</label>
											...
											<div class="box-body">	
												...
												<div class="product-item mb-2">
													<div class="form-group">
														...
														<div class="col-sm-4 nopadding-left">
															<label>DESCRIPTION</label>
															<input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control cost-desc-0" name="desc_est_cost[]">
														</div>
														<div class="col-sm-2 nopadding-left">
															<label>QTY</label>
													...
													function addMore2() {
														...
														<div class="product-item-cost-${costRow} mb-2">
															<div class="form-group">
																...
																<div class="col-sm-4 nopadding-left">
																	<label>DESCRIPTION</label>
																	<input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control cost-desc-${costRow}" name="desc_est_cost[]">
																</div>
																<div class="col-sm-2 nopadding-left">
																	<label>QTY</label>
