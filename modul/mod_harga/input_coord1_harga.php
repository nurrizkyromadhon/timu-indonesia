...
<!---------------------------------------------------- Menempatkan gambar indikasi -->
		<div style="position:absolute; left: <?=$x?>; top: <?=$y?>; ">
			<a href="../../oklogin.php?module=harga&act=tambah&id=<?=$id_coord?>" data-toggle="tooltip" title="<?=$title?>">
...
where c.id_profil='$id_profil' and h.ket!='Terjual'");
while ($hasil=mysql_fetch_array($query)){
	$id_coord=$hasil['id_coord'];
	//$img=$hasil['gambar'];
	$x1=$hasil['x'];
...
<!---------------------------------------------------- Menempatkan gambar indikasi -->
		<div style="position:absolute; left: <?=$x?>; top: <?=$y?>; ">
			<a href="../../oklogin.php?module=harga&act=edit&id=<?=$id_coord?>">
