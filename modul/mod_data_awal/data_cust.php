...
if (empty($_SESSION['username']) and empty($_SESSION['passuser'])) {
 ...
 <center>Untuk mengakses modul, Anda harus login <br>";
    ...
    $aksi = 'modul/mod_data_awal/aksi_data_cust.php';
        ...
        default: ?>
				...
				<div class="box box-default">
					<div class="box-header with-border">
						<h3 class="box-title">Tabel Customer
							
							<!-- Modal -->
							<div class="modal fade" id="nm_cust" role="dialog">
									...
									<div class="modal-content" style="color: black;">
										...
										<div class="modal-body" >
											...
											<div class="form-group">
												<input onkeyup="this.value = this.value.toUpperCase()" type="hidden" name="module" value="data_cust">
												<input onkeyup="this.value = this.value.toUpperCase()" type="hidden" name="act" value="tambah_data_cust">
											</div>																
											<div class="form-group">
												<label>CUSTOMER NAME :</label>
												<input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control" name="nm_cust">
											</div>
											<div class="form-group">
												<label>ADDRESS :</label>
												<textarea class="form-control" name="alamat_cust" onkeypress="return event.keyCode != 13"></textarea>
											</div>
											<div class="form-group">
												<label>CUSTMOER REFF :</label>
												<input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control" name="reff_cust">
											</div>
											<div class="form-group">
												<label>CUSTOMER CODE :</label>
												<input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control" name="code_cust">
											</div>
											<div class="form-group">
												<label>PIC :</label>
												<input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control" name="pic_cust">
											</div>
											<div class="form-group">
												<label>PHONE :</label>
												<input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control" name="phone_cust">
											</div>
						...
						<div class="box-tools pull-right">
							<a class="btn btn-default btn-sm" data-toggle="modal" href="#nm_cust">+</a>
						</div>
					</div>
					<!-- /.box-header -->
					<div class="box-body">
										...
										<tbody>
											...
											$no_cust=1;
												...
												while($hasil4=mysql_fetch_array($query4) or die(mysql_error())){
													$id_data_cust=$hasil4['id_data_cust'];	
											?>
											<tr>
												<td><?=$no_real_cost?></td>
												<td><?=$hasil4['nm_cust']?></td>
												<td><?=$hasil4['alamat_cust']?></td>
												<td><?=$hasil4['reff_cust']?></td>
												<td><?=$hasil4['code_cust']?></td>
												<td><?=$hasil4['pic_cust']?></td>
												<td><?=$hasil4['phone_cust']?></td>
												<td>
													<!-- Modal -->
												<div class="modal fade" id="data_cust<?=$id_data_cust?>" role="dialog">
													<div class="modal-dialog">
														<!-- Modal content-->
														<div class="modal-content" style="color: black;">
															<div class="modal-header">
															...
															<div class="modal-body" >
																<div class="form-group">
																	<input type="hidden" name="module" value="data_cust">
																	<input type="hidden" name="act" value="update_data_cust">
																	<input type="hidden" name="id_data_cust" value="<?=$id_data_cust?>">
																	...
																	<input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control" name="nm_cust" value="<?=$hasil4['nm_cust']?>">
																</div>
																
																<div class="form-group">
																	<label>ADDRESS :</label>
																	<input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control" name="alamat_cust" value="<?=$hasil4['alamat_cust']?>">																
																</div>
																<div class="form-group">
																	<label>CUSTOMER REFF :</label>
																	<input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control" name="reff_cust" value="<?=$hasil4['reff_cust']?>">																
																</div>
																<div class="form-group">
																	<label>CUSTOMER CODE :</label>
																	<input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control" name="code_cust" value="<?=$hasil4['code_cust']?>">																
																</div>
																<div class="form-group">
																	<label>PIC :</label>
																	<input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control" name="pic_cust" value="<?=$hasil4['pic_cust']?>">																
																</div>
																<div class="form-group">
																	<label>PHONE :</label>
																	<input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control" name="phone_cust" value="<?=$hasil4['phone_cust']?>">																
																</div>
												...
												<a class="btn btn-primary btn-sm" data-toggle="modal" href="#data_cust<?=$id_data_cust?>"><span class="fa fa-edit"></a>	
												<a class="btn btn-danger btn-sm" href="<?=$aksi?>?module=data_cust&act=delete_data_cust&id_data_cust=<?=$id_data_cust?>"><span class="fa fa-trash"></a>
												</td>
											...
											<div class="row with-border">
												<div class="col-md-6">
													...
													<div class="form-group">
														...
														<div class="col-sm-6">
															<input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control" name="cust_name"  autofocus required>
														</div>
													</div>
													<div class="form-group">
												...
												<div class="col-md-6">	
													<div class="form-group">
														...
														<div class="col-sm-6">
															<input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control" name="cust_ref" autofocus required>
														</div>
													</div>  
													<div class="form-group">
														<label class="col-sm-3 control-label">CUSTOMER CODE</label>
														<div class="col-sm-6">
															<input onkeyup="this.value = this.value.toUpperCase()" type="text" class="form-control" name="cust_code" autofocus required>
														</div>
													</div>
													<div class="form-group">
