...
if (empty($_SESSION['username']) and empty($_SESSION['passuser'])) {
 ...
 <center>Untuk mengakses modul, Anda harus login <br>";
    ...
    $aksi = 'modul/mod_jurnal_keg/aksi_jurnal_keu.php';
    switch ($_GET[act]) { 
		default: ?>
			<script>
										...
										<table id="myTable" class="table table-striped">
											...
											<tbody>
												...
												<tr>
													...
													<td>
													<button type="button" class="btn btn-success btn-sm" onclick="location.href='<?php echo '?module=jurnal_keu&act=jurnal&id='.$id_pf; ?>';" >Jurnal</i></button>
													</td>
												</tr>
												<?php $no++; } } ?>
											</tbody>	
														...
														<div class="col-md-6">
															...
															<table class="table table-striped">
																...
																<tr>					
																	...
																	<td align="right">
																	<?php
																		$query11=mysql_query("select *,sum(real_cost) as sum_real_revenue from pf_real_cost 
																		where category1 IN ('CASH','BANK') and id_revenue=$id_pf_revenue");
																		$hasil11=mysql_fetch_array($query11);
																			$sum_real_revenue= $hasil11['sum_real_revenue'];																			
																	?>
																		<?=number_format($sum_real_revenue)?>
																	</td>
																	<td>
																		<!-- Modal -->
																		<div class="modal fade" id="revenue<?=$id_pf_revenue?>" role="dialog">
																			<div class="modal-dialog">
																				...
																				<div class="modal-content" style="color: black;">
																					...
																					<form name="submit2" action="<?=$aksi?>" method="get">
																					<div class="modal-body" >
																						<div class="form-group">
																							<input type="hidden" name="module" value="jurnal_keu">
																							<input type="hidden" name="act" value="tambah_real_cost">
																							<input type="hidden" name="id_revenue" value="<?=$id_pf_revenue?>">
																							<input type="hidden" name="id_pf" value="<?=$id_pf?>">
																						</div>																
																						<div class="form-group">
																							<label>DATE :</label>
																							<input type="text" class="form-control" name="tgl_real_cost" value="<?=date('Y-m-d')?>" readonly>
																						</div>
																						<div class="form-group">
																							<label>STATUS :</label>
																							<input type="text" name="status_keu" class="form-control">
																						</div>
																						<div class="form-group">
																						...
																						<div class="form-group">
																							...
																							<input class="form-control" type="text" name="desc1" value="<?=$hasil2['type2_revenue']?>" readonly>
																							
																						</div>

																						<div class="form-group">
																							<label>DESCRIPTION 2 :</label>
																							<input type="text" name="desc2" class="form-control" value="<?=$hasil2['desc_revenue']?>" readonly>
																						</div>
																						<div class="form-group">
																						...
																						<div class="form-group">
																							<label>NOMINAL :</label>
																							<input type="text" name="real_cost" class="form-control" required>
           
																						</div>
																					</div>
																					<div class="modal-footer">
																						<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
																						<button type="submit2" class="btn btn-success">Tambah</button>
																					</div>
																					</form>
																				</div>
																			</div>
																		</div>
																		<a class="btn btn-default btn-sm" data-toggle="modal" href="#revenue<?=$id_pf_revenue?>">+</a>
																	</td>
																</tr>
														...
														<div class="col-md-6">
															...
															<table class="table table-striped">
																...
																<tr>				
																	...
																	<td align="right">
																		<?php
																			$query=mysql_query("select *,sum(real_cost) as sum_real_cost from pf_real_cost 
																			where category2 IN ('CASH','BANK') and id_est_cost=$id_pf_est_cost");
																			...
																			<div class="modal-dialog">
																				...
																				<div class="modal-content" style="color: black;">
																					...
																					<div class="modal-body" >
																						...
																						<div class="form-group">
																							<label>DESCRIPTION 2 :</label>
																							<input type="text" name="desc2" class="form-control" value="<?=$hasil3['desc_est_cost']?>" readonly>
																						</div>
																						<div class="form-group">
																							<label>DESCRIPTION 3 :</label>
																							<input type="text" name="desc3" class="form-control" >
							...
							<div class="table-responsive">
									...
									<table id="myTable1" class="table table-striped">
										...
										<tbody>
											<?php
											$no_real_cost=1;
												$query4=mysql_query("select * from pf_real_cost where id_pf=$id_pf order by id_pf_real_cost desc");
											...
											<tr>
												...
												<td>
													<!-- Modal -->
													<div class="modal fade" id="jurnal_keu<?=$id_pf_real_cost?>" role="dialog">
														<div class="modal-dialog">
															<!-- Modal content-->
															<div class="modal-content" style="color: black;">
																<div class="modal-header">
													...
													<a class="btn btn-primary btn-sm" data-toggle="modal" href="#jurnal_keu<?=$id_pf_real_cost?>"><span class="fa fa-edit"></a>	
													<a class="btn btn-danger btn-sm" href="<?=$aksi?>?module=jurnal_keu&act=delete_pf_real_cost&id=<?=$id_pf_real_cost?>&id_pf=<?=$id_pf?>" onclick="return confirm('Sudah Yakin Mau di Hapus')">
										...
										<div class="box-body">
												...
												<div class="col-md-6">
													<div class="form-group">
														...
														<div class="col-sm-6">
															...
															<?=$hariini?></p>
															<?=$harikemaren?>-->
															<input type="text" class="form-control" name="no_pf" value="PPL<?php echo date('ym');?><?=$urut?>"readonly>
														</div>
													</div>  
													<div class="form-group">
													...
													<div class="form-group">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control" name="cust_name"  autofocus required>
														</div>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<div class="col-sm-3">
															<input type="text" class="form-control" name="qty_pf"  autofocus required>
															
														</div>
														<div class="col-sm-3">
															<input type="text" class="form-control" name="type_qty" placeholder="Type" autofocus required>
														</div>
													</div>
													...
													<div class="form-group">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control" name="route_pf" autofocus required>
														</div>
													</div>  
													<div class="form-group">
														<label class="col-sm-3 control-label">PU/DEL DATE</label>
														<div class="col-sm-3">
															<input type="text" class="form-control" name="pudel_date" autofocus required>
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-3 control-label">PU/DEL LOCATION</label>
														<div class="col-sm-6">
															<input type="text" class="form-control" name="pudel_location" autofocus required >
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-3 control-label">CREDIT TERM</label>
														<div class="col-sm-6">
															<input type="text" class="form-control" name="ct"  autofocus required>
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-3 control-label">SALES</label>
														<div class="col-sm-6">
															<input type="text" class="form-control" name="sales"  autofocus required>
														</div>
													</div>
												</div>	
												<div class="col-md-6">	
													<div class="form-group">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control" name="cust_ref" autofocus required>
														</div>
													</div>  
													<div class="form-group">
														<label class="col-sm-3 control-label">CUSTOMER CODE</label>
														<div class="col-sm-6">
															<input type="text" class="form-control" name="cust_code" autofocus required>
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-3 control-label">PIC</label>
														<div class="col-sm-6">
															<input type="text" class="form-control" name="pic" autofocus required >
														</div>
													</div>
													<div class="form-group">
													...
													<div class="form-group">
														...
														<div class="col-sm-6">
															<input type="text" class="form-control" name="sf" autofocus required>
														</div>
													</div>  
													<div class="form-group">
														<label class="col-sm-3 control-label">VESSEL/VOYAGE</label>
														<div class="col-sm-6">
															<input type="text" class="form-control" name="vv" autofocus required>
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-3 control-label">ETB/ETD</label>
														<div class="col-sm-3">
															<input type="text" class="form-control" name="etb_etd" autofocus required >
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-3 control-label">OPEN STACK</label>
														<div class="col-sm-3">
															<input type="date" class="form-control" name="openstack"  autofocus required>
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-3 control-label">CLOSING TIME CONTAINER</label>
														<div class="col-sm-3">
															<input type="date" class="form-control" name="ctc" autofocus required >
														</div>
													</div>
													<div class="form-group">
														<label class="col-sm-3 control-label">CLOSING TIME DOCUMENT</label>
														<div class="col-sm-3">
															<input type="date" class="form-control" name="ctd"  autofocus required>
														</div>
													</div>	
													<div class="form-group">
														<label class="col-sm-3 control-label">B/L NUMBER</label>
														<div class="col-sm-6">
															<input type="text" class="form-control" name="bl_number" autofocus required >
														</div>
													</div>
												</div>
											</div>
											...
											<div class="box">
												...
												<div class="product-item form-group">
													<div class="col-sm-4">
														<input type="text" class="form-control" name="name_real_user[]" placeholder="Name Real User">
													</div>
													<div class="col-sm-4">
														<input type="text" class="form-control" name="address_real_user[]" placeholder="Address">
													</div>
													<div class="col-sm-2">
														<input type="text" class="form-control" name="phone_real_user[]" placeholder="Phone">
													</div>
													<div class="col-sm-2">
													...
													<script type="text/javascript">
														...
														function addMore() {
															idrow++;
															$("#product").append("<div class='product-item form-group'><div class='col-sm-4'><input type='text' class='form-control' name='name_real_user[]' placeholder='Name Real User'></div><div class='col-sm-4'><input type='text' class='form-control' name='address_real_user[]' placeholder='Address'></div><div class='col-sm-2'><input type='text' class='form-control' name='phone_real_user[]' placeholder='Phone'></div><div class='col-sm-2'><input type='checkbox' class='pull-left' name='item_index[]'></div></div>");
														}
											...
											<div class="box">
												...
												<div class="product-item form-group">
													<div class="col-sm-5">
														<input type="text" class="form-control" name="desc_sor[]" placeholder="Description">
													</div>
													<div class="col-sm-2">
														<input type="checkbox" class="pull-left" name="item_index[]">
													</div>
											...
											<div class="row with-border">
												...
												<div class="product-item form-group">
													...
													<div class="col-sm-3">
														<input type="text" class="form-control" name="desc_revenue[]" placeholder="Description">
													</div>
													<div class="col-sm-2">
														<input type="text" class="form-control" name="revenue[]" placeholder="(IDR) tanpa titik, koma">
													</div>
													<div class="col-sm-1">
														<input type="text" class="form-control" name="qty_revenue[]" placeholder="qty tanpa titik, koma">
													</div>
													<div class="col-sm-1">
														<input type="checkbox" class="pull-left" name="item_index[]">
													</div>
														...
														<script type="text/javascript">
															...
															function addMore1() {
																idrow++;
																$("#product1").append("<div class='product-item form-group'><div class='col-sm-2'><select class='form-control' name='type_revenue[]'><option value='ALL IN RATE'> ALL IN RATE </option><option value='AS ORDER'> AS ORDER </option></select></div><div class='col-sm-3'><select class='form-control' name='type2_revenue[]'><option value='SHIPPING/FORWARDING CHARGESRATE'> SHIPPING/FORWARDING CHARGES </option><option value='PORT CHARGES'> PORT CHARGES </option><option value='THIRD PARTY CHARGES'> THIRD PARTY CHARGES </option><option value='CUSTOMS AND OPERATION CHARGES'> CUSTOMS AND OPERATION CHARGES </option><option value='DEPO/CFS CHARGES'> DEPO/CFS CHARGES </option><option value='TRANSPORTATION CHARGES'> TRANSPORTATION CHARGES </option><option value='OTHERS CHARGES'> OTHERS CHARGES </option></select></div><div class='col-sm-3'><input type='text' class='form-control' name='desc_revenue[]' placeholder='Description'></div><div class='col-sm-2'><input type='text' class='form-control' name='revenue[]' placeholder='(IDR) tanpa titik, koma'></div><div class='col-sm-1'><input type='text' class='form-control' name='qty_revenue[]' placeholder='qty tanpa titik, koma'></div><div class='col-sm-1'><input type='checkbox' class='pull-left' name='item_index[]'></div></div>");
											...
											<div class="row with-border">
												...
												<div class="product-item form-group">
													...
													<div class="col-sm-3">
														<input type="text" class="form-control" name="desc_est_cost[]" placeholder="Description">
													</div>
													<div class="col-sm-2">
														<input type="text" class="form-control" name="est_cost[]" placeholder="(IDR) tanpa titik, koma">
													</div>
													<div class="col-sm-1">
														<input type="text" class="form-control" name="qty_est_cost[]" placeholder="qty tanpa titik, koma">
													</div>
													<div class="col-sm-1">
														<input type="checkbox" class="pull-left" name="item_index[]">
													</div>
														...
														<script type="text/javascript">
															...
															function addMore2() {
																idrow++;
																$("#product2").append("<div class='product-item form-group'><div class='col-sm-3'><select class='form-control' name='type_est_cost[]'><option value='SHIPPING/FORWARDING CHARGESRATE'> SHIPPING/FORWARDING CHARGES </option><option value='PORT CHARGES'> PORT CHARGES </option><option value='THIRD PARTY CHARGES'> THIRD PARTY CHARGES </option><option value='CUSTOMS AND OPERATION CHARGES'> CUSTOMS AND OPERATION CHARGES </option><option value='DEPO/CFS CHARGES'> DEPO/CFS CHARGES </option><option value='TRANSPORTATION CHARGES'> TRANSPORTATION CHARGES </option><option value='OTHERS CHARGES'> OTHERS CHARGES </option></select></div><div class='col-sm-3'><input type='text' class='form-control' name='desc_est_cost[]' placeholder='Description'></div><div class='col-sm-2'><input type='text' class='form-control' name='est_cost[]' placeholder='(IDR) tanpa titik, koma'></div><div class='col-sm-1'><input type='text' class='form-control' name='qty_est_cost[]' placeholder='qty tanpa titik, koma'></div><div class='col-sm-1'><input type='checkbox' class='pull-left' name='item_index[]'></div></div>");
															}
