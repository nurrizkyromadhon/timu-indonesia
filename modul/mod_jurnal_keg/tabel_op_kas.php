	...
	if (empty($_SESSION['username']) AND empty($_SESSION['passuser'])){
	    ...
	    ?>
	        <html>
                ...
                <h4 class="box-title"><b class="text-blue">Tabel Job Order</b> dari tgl <strong><?=$tgl_aw_str?></strong> s/d <strong><?=$tgl_ak_str?></strong> </h4>
                <table id="myTable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                        <?php
                            $no=1;
                            $qry=mysql_query("SELECT * from pf_log");
                ...
                <script>
                    function insertopr(id_op_kas) {
                        window.close();
                        window.opener.document.getElementById('id_op_kas<?=$_GET['idrow']?>').value = id_op_kas;
                    }
