...
if (empty($_SESSION['username']) and empty($_SESSION['passuser'])) {
 ...
 <center>Untuk mengakses modul, Anda harus login <br>";
    ...
    $aksi = 'modul/mod_jurnal_keg/aksi_jurnal_overhead.php';
        ...
        default: ?>
				...
				<div class="box box-default">
					<div class="box-header with-border">
						<h3 class="box-title">Tabel jurnal Keuangan Overhead
									...
									<div class="modal-content" style="color: black;">
										...
										<div class="modal-body" >
											<div class="form-group">
												<input type="hidden" name="module" value="jurnal_overhead">
												<input type="hidden" name="act" value="tambah_real_cost_overhead">
											</div>																
											<div class="form-group">
												<label>DATE</label>
											...
											<select class="form-control" name="category1">
													...
													<option value="PENDAPTAN"> PENDAPATAN </option>
								...
								<div class="col-md-12">
									<table class="table table-striped" id="myTable">
										...
										<tbody>
											<?php
											$no_real_cost=1;
												$query4=mysql_query("select * from pf_real_cost where id_pf='0'");
											...
											<tr>
												...
												<td>
													<!-- Modal -->
													<div class="modal fade" id="jurnal_overhead<?=$id_pf_real_cost?>" role="dialog">
														<div class="modal-dialog">
															<!-- Modal content-->
															<div class="modal-content" style="color: black;">
																<div class="modal-header">
																...
																<div class="modal-body" >
																	<div class="form-group">
																		<input type="hidden" name="module" value="jurnal_overhead">
																		<input type="hidden" name="act" value="update_ov">
													...
													<a class="btn btn-primary btn-sm" data-toggle="modal" href="#jurnal_overhead<?=$id_pf_real_cost?>"><span class="fa fa-edit"></a>	
													<a class="btn btn-danger btn-sm" href="<?=$aksi?>?module=jurnal_overhead&act=delete_overhead&id=<?=$id_pf_real_cost?>" onclick="return confirm('Sudah Yakin Mau di Hapus')">
