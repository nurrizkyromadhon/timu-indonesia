...
session_start();
 ...
 <center>Untuk mengakses modul, Anda harus login <br>";
  echo "<a href=../../index.php><b>LOGIN</b></a></center>";
	...
	$aksi="modul/mod_balancing_sheet/aksi_balancing_sheet.php";
	switch($_GET[act]){
		// Tampil User
		default:
			?>
								...
								<div class="col-md-12">
									<div class="container">
										<div class="table-responsive">
											<lable><h2>CASH FLOW TAHUN <?=$_POST['thn']?></h2></lable>
											<table class="table table-bordered table-striped">
												<thead>
												<tr>
													<th>NO</th>
													<th>SUMBER MASUKAN</th>
													<?php
													if($_POST[thn]==''){
													    $thn=date(Y);
													}else{
												...
												<tbody>
													<?php
														...
														where p.kode_perkiraan between '1.5.01.001' and '2.1.01.999'
														group by j.id_perkiraan 
