...
session_start();
 ...
 <center>Untuk mengakses modul, Anda harus login <br>";
  echo "<a href=../../index.php><b>LOGIN</b></a></center>";
	...
	$aksi="modul/mod_batal/aksi_batal.php";
	switch($_GET[act]){
		// Tampil User
		default:
			?>
							...
							<div class="row">
								...
								<div class="col-md-12">
									...
									$no=1;
										...
										where n.id_indikasi!='1' and aproval='OK'
									  ...
									  ?>
										  <tr>
											...
											<td>
												<button type="button" class="btn btn-danger" onclick="location.href='<?php echo "?module=batal&act=tambah&id=$id_nasabah";?>';" ><i class="fa fa-check"></i></button>
											</td>
										  </tr>
									  <?php
										$no++; } 
		...
		case "tambah":
			?>
				<section class="content-header">
					<h1>Pembatalan User</h1>
					<ol class="breadcrumb">
						<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
						<li><a href="#">Pembatalan</a></li>
						<li class="active">Form Pembatalan</li>
					</ol>
				</section>
							...
							<div class="row">
								...
								<div class="col-md-12">	
									...
									<form class="form-horizontal" method="POST" action="<?=$aksi?>?module=batal&act=batal">
										<div class="col-md-6">	
										<H3 align="center">Pembatalan :</H3>
												<div class="box-body">
													<div class="form-group">
														<label class="col-sm-5 control-label">Tanggal Batal:</label>
														<div class="col-sm-5">
															<input class="form-control" type="text" name="tgl" value="<?=date('Y-m-d')?>" readonly/>
														</div>
													</div>											
													<div class="form-group">
													...
													<div class="form-group">
														...
														<div class="col-sm-5">
														  <input class="form-control" type="text" name="disc" value="<?=number_format($hasil0['kpr'])?>" readonly   />
														</div>
													</div>	
													<div class="form-group">
