<?php
	...
	/*	mysql_query("UPDATE pf_est_cost SET cek_est_cost = '0' ");
		
		$query=mysql_query("select * from pf_real_cost");
		while ($hasil=mysql_fetch_array($query)){
		   $id_est_cost=$hasil['id_est_cost'];
		   
		   mysql_query("UPDATE pf_est_cost SET cek_est_cost = '1' where id_pf_est_cost=$id_est_cost ");
		...
		elseif ($module=='jurnal_keu2' AND $act=='excel'){
			...
			join pf_est_cost as pec on prc.id_est_cost=pec.id_pf_est_cost
			");
