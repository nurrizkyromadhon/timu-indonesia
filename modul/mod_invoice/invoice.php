																		...
																		<div class="modal-body">
																			<div class="row" >
																					...
																					<div class="row mt-2">
																						<div class="form-group col-sm-3">
																							...
																							<select id="npwp" class="form-control" name="npwp" required>
																								...
																								<option value="01.963.507.7-607.001"> 01.963.507.7-607.001</option>
																								<option value="01.963.507.7-518.001" selected> 01.963.507.7-518.001</option>																					
																							</select>
																						</div>																																												
																					</div>
																					<div class="row mt-2">
																				...
																				<div class="col-sm-6">
																						...
																						<div class="row mt-2">
																							<label><b>DOWN PAYMENT : </b></label><br>
																						    <?php
																							$qrydp=mysql_query("select * from pf_real_cost where id_pf_log='$id_pf_log' and category1 = 'OP AR'");
																							while ($hsldp=mysql_fetch_array($qrydp)){
																							?>																					
																								<input type="radio" name="dp" value="<?=$hsldp['real_cost']?>"> <?=number_format($hsldp['real_cost'])?> - <?=$hsldp['bukti']?><br>
																							<?php
																							} 
																							?>
														...
														<tr>
															...
															?>	
																...
																<td>
																	...
																	<b>TOTAL : <?=number_format($total_saldo)?></b>
																</td>
															<?php
															} else {
